            ...
            <main>
                <div className="max-w-xl mx-auto">
                    ...
                    <ul className="space-y-4 flex flex-col justify-center items-center">
                        <li className="cyber-tile-big hover:shadow-2xl hover:scale-105 transition bg-blue text-white p-4 ">
                    ...
                    <ul className="space-y-4 flex flex-col justify-center items-center">
                        <li className="cyber-tile-big hover:shadow-2xl hover:scale-105 transition bg-blue border-2 border-500 text-black p-4 rounded">
                            Um baralho poderá ter um mínimo de 12 e o máximo de 22 cartas
                        </li>
                        <li className="cyber-tile-big hover:shadow-2xl hover:scale-105 transition bg-blue border-2 border-500 text-black p-4 rounded">
                    ...
                    <ul className="space-y-4 mb-5 flex flex-col justify-center items-center">
                        <li className="cyber-tile-big hover:shadow-2xl hover:scale-105 transition bg-red border-2 border-500 text-white p-4 rounded">
